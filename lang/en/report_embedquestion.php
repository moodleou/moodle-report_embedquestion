...
$string['downloadresponseinfo'] = 'Your question responses can be downloaded.';
$string['downloadresponseinfo_help'] = 'You can download all responses in this document using the \'Download all response files\' button, or you can select individual questions and use the \'Download selected response files\' button.';
